	...
	<div class="row">
						...
						<div class="form-content form-type-one">
							...
							<form:form action="${url}" modelAttribute="myaddress"
								...
								<div class="form-group">
									...
									<form:input name="addressLine1" class="form-control"
										id="line1" placeholder="Address Line1" path="addressLine1" />
								...
								<div class="form-group">
									...
									<form:input type="text" name="address_line2"
										...
										placeholder="AddressLine2" path="addressLine2" />
								...
								<div class="form-group">
									<label for="email"> Phn No:</label>
									<form:input type="text" name="pincode" id="phone"
										placeholder="Phn No" path="phone"
										class="form-control my-input" />
								</div>
								<br>
								<center>
								...
								<form:hidden path="user.userId" value="${sessionScope.usercartid}" />
		...
		<div class="col-md-8">
			<div class="row" style="margin-top: 0%">
				<c:forEach items="${addresslist}" var="v">
					<div class="col-lg-4">
						<div class="thumbnail card">
							...
							<div class="caption card-body" style="font-family: Geneva">
								...
								<div class="row">
									<div class="col-xs-12">
										<p class="lead">${v.userName}<br>${v.addressLine1},<br>
											${v.addressLine2},<br> ${v.city},<br> ${v.state},<br>
											${v.pincode},<br> ${v.phone}.
										</p>
									</div>
								</div>
								<div class="row">
									<div class="col-xs-12">
										<a class="btn btn-success fa fa-pencil"
											href="${cr}/user/editAddress?addressId=${v.addressId}"></a> <a
											class="btn btn-success fa fa-trash"
											href="${cr}/user/deleteAddress?addressId=${v.addressId}"></a> <a
