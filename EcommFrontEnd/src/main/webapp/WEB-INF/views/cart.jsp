					...
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach items="${cartitems}" var="cart">
								<tr>
									<td><img
										src="${cr}/resources/pimages/${cart.product.productid}.jpg"
										height="50px" /></td>
									<td>${cart.product.productid}</td>
									<td>In stock</td>
									<td><input class="form-control" type="text"
										value="${cart.qty}" readonly="true" /></td>
									<td class="text-right">${cart.total}</td>
									<td class="text-right"><a
										href="${cr}/deletecart?cartId=${cart.cartId}"
							...
							<tr>
								...
								<td></td>
								<td>Shipping</td>
								<td class="text-right"><a href="${cr}/cart"></a>Rs.
			...
			<div class="col mb-2">
				<div class="row">
					<div class="col-sm-12  col-md-6">
						<a href="${cr}/viewallproducts" class="btn btn-block btn">Continue
							Shopping</a>
